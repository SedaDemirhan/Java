...
scan.close();
 ...
 private static void dörtSayitopla() {
	   Scanner scan=new Scanner(System.in);
		System.out.println("Lütfen üc tamsayi giriniz:");
		   int sayi1=scan.nextInt();
		   int sayi2=scan.nextInt();
		   int sayi3=scan.nextInt();
		   int sayi4=scan.nextInt();
		   System.out.println("sayýlarýn toplamý:"+(sayi1+sayi2+sayi3+sayi4));
		scan.close();
...
private static void ücSayiTopla() {
	   Scanner scan=new Scanner(System.in);
		System.out.println("Lütfen üc tamsayi giriniz:");
		   ...
		   int sayi2=scan.nextInt();
		   int sayi3=scan.nextInt();
		   System.out.println("sayýlarýn toplamý:"+(sayi1+sayi2+sayi3));
		scan.close();
	}
