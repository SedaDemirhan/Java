 ...
 */
		...
		//her bir inner array'in elemanlarýnýn toplamýný yeni array'e element olarak yazýcaz
		
		int toplamlarArrayi[]=new int[arr.length];// inner array sayýsýnz uygun bir array oluþturacak
